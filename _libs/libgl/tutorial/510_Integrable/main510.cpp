...
void showHelp()
{
    cerr << endl;
    cerr << "          HELP" << endl;
    cerr << "            Key '1'   Displaying original field, its singularities and its cuts" << endl;
    cerr << "            Key '2'   Displaying current field, its singularities and its cuts" << endl;
    cerr << "            Key '3'   Displaying original field and its curl" << endl;
    cerr << "            Key '4'   Displaying current field and its curl" << endl;
    cerr << "            Key '5'   Displaying original poisson-integrated field and original poisson error" << endl;
    cerr << "            Key '6'   Displaying current poisson-integrated field and current poisson error" << endl;
    cerr << "            Key '7'   Displaying original texture with cuts and singularities" << endl;
    cerr << "            Key '8'   Displaying current texture with cuts and singularities" << endl;
    cerr << "            Key '9'   Displaying original field overlayed onto the current integrated field" << endl;
    cerr << "            Key '0'   Displaying current field overlayed onto the current integrated field" << endl;
    cerr << "            Key 'A'   Improve Curl in 5 iterations" << endl;
    cerr << "            Author: Olga Diamanti - Postdoctoral Researcher, Geometric Computing Lab, Stanford University, http://web.stanford.edu/~diamanti/" << endl;
    cerr << endl;
}

...
public:
    ...
    void setParent(Widget *parent) { mParent = parent; markDity(); }
    ...
    void setLayout(Layout *layout) { mLayout = layout; markDity(); }
    ...
    void setPosition(const Vector2i &pos) { mPos = pos; markDity(); }
    ...
    void setSize(const Vector2i &size) { mSize = size; markDity(); }

    /// Return the width of the widget
    int width() const { return mSize.x(); }
    /// Set the width of the widget
    void setWidth(int width)  {  mSize.x() = width;  markDity(); }

    /// Return the height of the widget
    int height() const { return mSize.y(); }
    /// Set the height of the widget
    void setHeight(int height) { mSize.y() = height; markDity(); }
     ...
     */
    void setFixedSize(const Vector2i &fixedSize) { mFixedSize = fixedSize; markDity(); }
    ...
    void setFixedWidth(int width) { mFixedSize.x() = width; markDity(); }
    /// Set the fixed height (see \ref setFixedSize())
    void setFixedHeight(int height) { mFixedSize.y() = height; markDity(); }
    ...
    void setVisible(bool visible) {
        if (mVisible!= visible) markDity(); mVisible = visible;  }
    ...
    void setId(const std::string &id) { mId = id; markDity(); }
    /// Return the ID value associated with this widget, if any
    const std::string &id() const { return mId; }

    /// Associate this widget with an Index value (optional)
    void setIndex(int index) { mIndex = index; markDity(); }
    /// Return the Index value associated with this widget, if any
    const int &index() const  { return mIndex; }

    /// Associate this widget with an resolution index for gridlayout (optional) (used in Combobox)
    void setGridLayoutResolutionIndex(int index)
    {
        mGridLayoutResolutionIndex = index;
        markDity();
    }
    /// Return the resolution index for gridlayout associated with this widget, if any (used in Combobox)
    const int &GridLayoutResolutionIndex() const
    {
        return mGridLayoutResolutionIndex;
    }

    /// Return whether or not this widget is currently enabled
    bool enabled() const { return mEnabled; }
    /// Set whether or not this widget is currently enabled
    void setEnabled(bool enabled) { mEnabled = enabled; markDity(); }
    ...
    void setFocused(bool focused) { mFocused = focused; markDity(); }
    /// Request the focus to be moved to this widget
    void requestFocus();

    const std::string &tooltip() const { return mTooltip; }
    void setTooltip(const std::string &tooltip) { mTooltip = tooltip; markDity(); }
    Widget* setUnitPercent(){return this;}; // dummy method to help intelisence - will be replace in TextBox widget
    Widget* setUnitAngle(){return this;}; // dummy method to help intelisence - will be replace in TextBox widget
    Widget* setUnitNum(){ return this;}; // dummy method to help intelisence - will be replace in TextBox widget

    /// Return current font size. If not set the default of the current theme will be returned
    int fontSize() const;
    /// Set the font size of this widget
    void setFontSize(int fontSize) { mFontSize = fontSize; markDity(); }
    ...
    void setCursor(Cursor cursor) { if (mCursor != cursor) markDity(); mCursor = cursor;  }
    ...
    virtual void draw(NVGcontext *ctx, bool drawOnlyGui);
...
protected:
    ...
    std::string mId;
    int mIndex;
    int mGridLayoutResolutionIndex;

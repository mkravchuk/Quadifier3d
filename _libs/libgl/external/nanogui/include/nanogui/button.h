...
public:
    ...
    void setCaption(const std::string &caption) { mCaption = caption; markDity();}

    const Color &backgroundColor() const { return mBackgroundColor; }
    void setBackgroundColor(const Color &backgroundColor) { mBackgroundColor = backgroundColor; markDity(); }

    const Color &textColor() const { return mTextColor; }
    void setTextColor(const Color &textColor) { mTextColor = textColor; markDity(); }

    int icon() const { return mIcon; }
    void setIcon(int icon) { mIcon = icon; markDity(); }

    int flags() const { return mFlags; }
    void setFlags(int buttonFlags) { mFlags = buttonFlags; markDity(); }

    IconPosition iconPosition() const { return mIconPosition; }
    void setIconPosition(IconPosition iconPosition) { mIconPosition = iconPosition; markDity(); }

    bool pushed() const { return mPushed; }
    void setPushed(bool pushed) { mPushed = pushed; markDity(); }
    ...
    void setButtonGroup(const std::vector<Button *> &buttonGroup) { mButtonGroup = buttonGroup; markDity(); }

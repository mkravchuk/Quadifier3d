...
public:
    ...
    void setBackground(const Color &background) { mBackground = background; markDity(); }
    ...
    virtual bool resizeEvent(const Vector2i &) { markDity();return false;  }
...
public:
    ...
    void drawWidgets(bool drawOnlyGui);

...
TextBox::TextBox(Widget *parent, const std::string &value)
    ...
    mUnits(""),
    mUnitType(TextBoxUnitType::Default),
    mFormat(""),
    mUnitsImage(-1),
    mValidFormat(true),
    mValueTemp(value),
...
TextBox* TextBox::setUnits(const std::string& units)
{
    mUnitType = TextBoxUnitType::Default;
    mUnits = units;
    markDity();
...
Widget* TextBox::setUnitPercent()
{
    mUnitType = TextBoxUnitType::Percent;
    mDefaultValue = "1";
    mUnits = "%";
    markDity();
    return this;
...
Widget* TextBox::setUnitAngle()
{
    mUnitType = TextBoxUnitType::Angle;
    mUnits = "\"";// "°";°©˚*º
    markDity();
    return this;
}

Widget* TextBox::setUnitNum()
{
    mUnitType = TextBoxUnitType::Num;
    mDefaultValue = "-1";
    mUnits = "#";
    markDity();
    return this;
...
void TextBox::draw(NVGcontext* ctx, bool drawOnlyGui)
{
    ...
    else if (!mUnits.empty())
    {
        ...
        nvgFillColor(ctx, Color(mTheme->mTextColor.r(), mTheme->mTextColor.g(), mTheme->mTextColor.b(), (mEnabled ? 64.0 : 32.0) / 255.0));
    ...
    if (mUnitType == TextBoxUnitType::Num && mValue == "-1")
    {
        textcolor = Color(textcolor.r(), textcolor.g(), textcolor.b(), (mEnabled ? 64.0 : 32.0) / 255.0);
    }

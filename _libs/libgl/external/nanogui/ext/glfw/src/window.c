...
void glfwDefaultWindowHints(void)
{
    ...
    _glfw.hints.window.recreateWindowAfterLoadExtensions = GLFW_TRUE;
    ...
    _glfw.hints.framebuffer.depthBits    = 24;   // 24 is enought, and is good because 24+8 = 32  (24-bits will be used for depth, and the remaining 8-bits for stencil)
    _glfw.hints.framebuffer.stencilBits  = 8;  // 8 - is good because 24+8 = 32  (24-bits will be used for depth, and the remaining 8-bits for stencil)
...
GLFWAPI void glfwWindowHint(int hint, int value)
{
    ...
    switch (hint)
    {
        ...
        case GLFW_VISIBLE:
            ...
            break;
        case GLFW_RECREATE_WINDOW_AFTER_LOAD_EXTENSIONS:
            _glfw.hints.window.recreateWindowAfterLoadExtensions = value;
            break;

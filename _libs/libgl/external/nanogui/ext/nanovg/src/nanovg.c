...
static NVGcompositeOperationState nvg__compositeOperationState(int op)
{
    ...
    //state.srcRGB = NVG_ONE;
    //state.dstRGB = NVG_ONE_MINUS_DST_ALPHA;
    //state.srcAlpha = NVG_ONE;
    //state.dstAlpha = NVG_ZERO;
    //state.srcAlpha = NVG_SRC_ALPHA; //Mupoc - fixing alpha - copy alpha to image, to be able later use it when blending layers

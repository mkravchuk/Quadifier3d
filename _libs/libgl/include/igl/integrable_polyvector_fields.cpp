...
template igl::IntegrableFieldSolverData<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixXd, Eigen::MatrixXd >::IntegrableFieldSolverData();
template void igl::integrable_polyvector_fields_solve<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixXd, Eigen::MatrixXd >(igl::IntegrableFieldSolverData<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixXd, Eigen::MatrixXd >&, igl::integrable_polyvector_fields_parameters&, Eigen::PlainObjectBase<Eigen::MatrixXd >&, bool);
template void igl::integrable_polyvector_fields_precompute<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixXd, Eigen::MatrixXd >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::VectorXi const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::VectorXi const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, igl::IntegrableFieldSolverData<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixXd, Eigen::MatrixXd >&);
#endif

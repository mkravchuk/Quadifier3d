...
template igl::SolverStatus igl::active_set<double, Eigen::VectorXd, Eigen::VectorXi, Eigen::VectorXd, double, Eigen::VectorXd, double, Eigen::VectorXd, Eigen::VectorXd, Eigen::VectorXd, Eigen::VectorXd >(Eigen::SparseMatrix<double, 0, int> const&, Eigen::PlainObjectBase<Eigen::VectorXd > const&, Eigen::PlainObjectBase<Eigen::VectorXi > const&, Eigen::PlainObjectBase<Eigen::VectorXd > const&, Eigen::SparseMatrix<double, 0, int> const&, Eigen::PlainObjectBase<Eigen::VectorXd > const&, Eigen::SparseMatrix<double, 0, int> const&, Eigen::PlainObjectBase<Eigen::VectorXd > const&, Eigen::PlainObjectBase<Eigen::VectorXd > const&, Eigen::PlainObjectBase<Eigen::VectorXd > const&, igl::active_set_params const&, Eigen::PlainObjectBase<Eigen::VectorXd >&);
template igl::SolverStatus igl::active_set<double, Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixXd, double, Eigen::VectorXd, double, Eigen::MatrixXd, Eigen::MatrixXd, Eigen::MatrixXd, Eigen::MatrixXd >(Eigen::SparseMatrix<double, 0, int> const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::SparseMatrix<double, 0, int> const&, Eigen::PlainObjectBase<Eigen::VectorXd > const&, Eigen::SparseMatrix<double, 0, int> const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, igl::active_set_params const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
#endif

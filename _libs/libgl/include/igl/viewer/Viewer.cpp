...
namespace viewer
{
  IGL_INLINE void Viewer::init()
  {
    ...
    ngui->setFixedSize(Eigen::Vector2i(130,20)); //Mupoc - width of values - extended

    // Create nanogui widgets
    //nanogui::Window *window = ngui->addWindow(Eigen::Vector2i(10, 10), "libIGL-Viewer");
    nanogui::Window *window = ngui->addWindow(Eigen::Vector2i(0,0),""); //- dont give title and set at left-top corner
...
//    }
  ...
  IGL_INLINE int  Viewer::launch_init(bool resizable, bool fullscreen, bool maximized, std::string windowTitle)
  {
    ...
    {
      window = glfwCreateWindow(1280,800, windowTitle.c_str(),nullptr,nullptr);
    }
  ...
  IGL_INLINE int Viewer::launch(bool resizable,bool fullscreen, bool maximized, std::string windowTitle)
  {
    // TODO return values are being ignored...
    launch_init(resizable,fullscreen, maximized, windowTitle);

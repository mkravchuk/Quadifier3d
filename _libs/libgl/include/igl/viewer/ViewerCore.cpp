...
#if EROW
  Eigen::Matrix4f modelT = model.transpose();
  Eigen::Matrix4f viewT = view.transpose();
  Eigen::Matrix4f projT = proj.transpose();
#else
  Eigen::Matrix4f modelT = model;
  Eigen::Matrix4f viewT = view;
  Eigen::Matrix4f projT = proj;
#endif

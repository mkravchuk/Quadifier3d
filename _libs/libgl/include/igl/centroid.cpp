...
template void igl::centroid<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::Vector3d >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::Vector3d >&);
#endif

...
template void igl::rgb_to_hsv<Eigen::MatrixXd, Eigen::MatrixXd >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
template void igl::rgb_to_hsv<Eigen::MatrixXf, Eigen::MatrixXf >(Eigen::PlainObjectBase<Eigen::MatrixXf > const&, Eigen::PlainObjectBase<Eigen::MatrixXf >&);

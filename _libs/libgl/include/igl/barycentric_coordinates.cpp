...
template void igl::barycentric_coordinates<Eigen::MatrixXd, Eigen::MatrixXd, Eigen::MatrixXd, Eigen::MatrixXd, Eigen::MatrixXd, Eigen::MatrixXd >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
...
template void igl::barycentric_coordinates<Eigen::Matrix<double, 1, 2, 1, 1, 2>, Eigen::Block<Eigen::MatrixXd const, 1, -1, false>, Eigen::Block<Eigen::MatrixXd const, 1, -1, false>, Eigen::Block<Eigen::MatrixXd const, 1, -1, false>, Eigen::Matrix<double, 1, 3, 1, 1, 3> >(Eigen::MatrixBase<Eigen::Matrix<double, 1, 2, 1, 1, 2> > const&, Eigen::MatrixBase<Eigen::Block<Eigen::MatrixXd const, 1, -1, false> > const&, Eigen::MatrixBase<Eigen::Block<Eigen::MatrixXd const, 1, -1, false> > const&, Eigen::MatrixBase<Eigen::Block<Eigen::MatrixXd const, 1, -1, false> > const&, Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 3, 1, 1, 3> >&);
template void igl::barycentric_coordinates<Eigen::Matrix<double, 1, 3, 1, 1, 3>, Eigen::Block<Eigen::MatrixXd const, 1, -1, false>, Eigen::Block<Eigen::MatrixXd const, 1, -1, false>, Eigen::Block<Eigen::MatrixXd const, 1, -1, false>, Eigen::Matrix<double, 1, 3, 1, 1, 3> >(Eigen::MatrixBase<Eigen::Matrix<double, 1, 3, 1, 1, 3> > const&, Eigen::MatrixBase<Eigen::Block<Eigen::MatrixXd const, 1, -1, false> > const&, Eigen::MatrixBase<Eigen::Block<Eigen::MatrixXd const, 1, -1, false> > const&, Eigen::MatrixBase<Eigen::Block<Eigen::MatrixXd const, 1, -1, false> > const&, Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 3, 1, 1, 3> >&);
template void igl::barycentric_coordinates<Eigen::MatrixXd, Eigen::MatrixXd, Eigen::MatrixXd, Eigen::MatrixXd, Eigen::MatrixXd >(Eigen::MatrixBase<Eigen::MatrixXd > const&, Eigen::MatrixBase<Eigen::MatrixXd > const&, Eigen::MatrixBase<Eigen::MatrixXd > const&, Eigen::MatrixBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
#endif

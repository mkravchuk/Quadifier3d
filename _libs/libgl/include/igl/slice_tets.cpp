...
template void igl::slice_tets<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::Matrix<double, 4, 1, 0, 4, 1>, Eigen::MatrixXd, Eigen::MatrixXi, Eigen::VectorXi, double>(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::Matrix<double, 4, 1, 0, 4, 1> > const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&, Eigen::PlainObjectBase<Eigen::VectorXi >&, Eigen::SparseMatrix<double, 0, int>&);
template void igl::slice_tets<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::VectorXd, Eigen::MatrixXd, Eigen::MatrixXi, Eigen::VectorXi, double>(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::VectorXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&, Eigen::PlainObjectBase<Eigen::VectorXi >&, Eigen::SparseMatrix<double, 0, int>&);
#endif

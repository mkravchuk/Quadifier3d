...
template Eigen::Matrix3d igl::rotation_matrix_from_directions<double>(const Eigen::Vector3d, const Eigen::Vector3d);
template Eigen::Matrix3f igl::rotation_matrix_from_directions<float>(const Eigen::Vector3f, const Eigen::Vector3f);
#endif

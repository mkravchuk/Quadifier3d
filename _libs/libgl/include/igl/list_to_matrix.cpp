...
// generated by autoexplicit.sh
template bool igl::list_to_matrix<int, Eigen::MatrixX2i >(std::vector<std::vector<int, std::allocator<int> >, std::allocator<std::vector<int, std::allocator<int> > > > const&, Eigen::PlainObjectBase<Eigen::MatrixX2i >&);
// generated by autoexplicit.sh
template bool igl::list_to_matrix<double, Eigen::MatrixX2d >(std::vector<std::vector<double, std::allocator<double> >, std::allocator<std::vector<double, std::allocator<double> > > > const&, Eigen::PlainObjectBase<Eigen::MatrixX2d >&);
// generated by autoexplicit.sh
...
// generated by autoexplicit.sh
template bool igl::list_to_matrix<double, Eigen::Vector3d >(std::vector<double, std::allocator<double> > const&, Eigen::PlainObjectBase<Eigen::Vector3d >&);
// generated by autoexplicit.sh
...
template bool igl::list_to_matrix<double, Eigen::MatrixX3d >(std::vector<std::vector<double, std::allocator<double> >, std::allocator<std::vector<double, std::allocator<double> > > > const&, Eigen::PlainObjectBase<Eigen::MatrixX3d >&);
...
template bool igl::list_to_matrix<double, Eigen::MatrixXd >(std::vector<std::vector<double, std::allocator<double> >, std::allocator<std::vector<double, std::allocator<double> > > > const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
template bool igl::list_to_matrix<int, Eigen::MatrixX3i >(std::vector<std::vector<int, std::allocator<int> >, std::allocator<std::vector<int, std::allocator<int> > > > const&, Eigen::PlainObjectBase<Eigen::MatrixX3i >&);
template bool igl::list_to_matrix<int, Eigen::MatrixXi >(std::vector<std::vector<int, std::allocator<int> >, std::allocator<std::vector<int, std::allocator<int> > > > const&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
...
template bool igl::list_to_matrix<int, Eigen::VectorXi >(std::vector<int, std::allocator<int> > const&, Eigen::PlainObjectBase<Eigen::VectorXi >&);
template bool igl::list_to_matrix<unsigned long, Eigen::VectorXi >(std::vector<unsigned long, std::allocator<unsigned long> > const&, Eigen::PlainObjectBase<Eigen::VectorXi >&);
template bool igl::list_to_matrix<float, Eigen::MatrixXf >(std::vector<std::vector<float, std::allocator<float> >, std::allocator<std::vector<float, std::allocator<float> > > > const&, Eigen::PlainObjectBase<Eigen::MatrixXf >&);
...
template bool igl::list_to_matrix<bool, Eigen::MatrixXi >(std::vector<bool, std::allocator<bool> > const&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
template bool igl::list_to_matrix<bool, Eigen::MatrixXi >(std::vector<std::vector<bool, std::allocator<bool> >, std::allocator<std::vector<bool, std::allocator<bool> > > > const&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
template bool igl::list_to_matrix<double, Eigen::VectorXd >(std::vector<double, std::allocator<double> > const&, Eigen::PlainObjectBase<Eigen::VectorXd >&);
template bool igl::list_to_matrix<double, Eigen::MatrixXd >(std::vector<double, std::allocator<double> > const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
template bool igl::list_to_matrix<int, Eigen::MatrixXi >(std::vector<int, std::allocator<int> > const&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
template bool igl::list_to_matrix<unsigned long, Eigen::MatrixXi >(std::vector<unsigned long, std::allocator<unsigned long> > const&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
...
template bool igl::list_to_matrix<unsigned long, Eigen::VectorXl >(std::vector<unsigned long, std::allocator<unsigned long> > const&, Eigen::PlainObjectBase<Eigen::VectorXl >&);
...
template bool igl::list_to_matrix<double, Eigen::MatrixXd >(std::vector<double, std::allocator<double> > const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
template bool igl::list_to_matrix<unsigned long, Eigen::MatrixXi >(std::vector<unsigned long, std::allocator<unsigned long> > const&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
template bool igl::list_to_matrix<unsigned __int64, class Eigen::Matrix<int, -1, -1, EROW, -1, -1> >(class std::vector<unsigned __int64, class std::allocator<unsigned __int64> > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<int, -1, -1, EROW, -1, -1> > &);

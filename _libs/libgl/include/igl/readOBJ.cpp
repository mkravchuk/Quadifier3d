  ...
  Eigen::PlainObjectBase<DerivedF>& F)
{
  ...
  //std::cout << "Vertexes " << F.size() << std::endl;
...
template bool igl::readOBJ<Eigen::MatrixXd, Eigen::MatrixXi >(std::basic_string<char, std::char_traits<char>, std::allocator<char> >, Eigen::PlainObjectBase<Eigen::MatrixXd >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
template bool igl::readOBJ<Eigen::MatrixX3d, Eigen::MatrixX3i >(std::string, Eigen::PlainObjectBase<Eigen::MatrixX3d >&, Eigen::PlainObjectBase<Eigen::MatrixX3i >&);
template bool igl::readOBJ<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixXd >(std::basic_string<char, std::char_traits<char>, std::allocator<char> >, Eigen::PlainObjectBase<Eigen::MatrixXd >&, Eigen::PlainObjectBase<Eigen::MatrixXd >&, Eigen::PlainObjectBase<Eigen::MatrixXd >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
#endif

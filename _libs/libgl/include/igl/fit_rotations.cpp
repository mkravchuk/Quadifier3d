...
template void igl::fit_rotations<Eigen::MatrixXd, Eigen::MatrixXd >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, bool, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
template void igl::fit_rotations_planar<Eigen::MatrixXd, Eigen::MatrixXd >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
template void igl::fit_rotations_planar<Eigen::MatrixXf, Eigen::MatrixXf >(Eigen::PlainObjectBase<Eigen::MatrixXf > const&, Eigen::PlainObjectBase<Eigen::MatrixXf >&);
template void igl::fit_rotations<Eigen::MatrixXf,Eigen::MatrixXf >(Eigen::PlainObjectBase<Eigen::MatrixXf > const &,bool,Eigen::PlainObjectBase<Eigen::MatrixXf > &);
#endif

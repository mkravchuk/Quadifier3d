...
template void igl::nchoosek<Eigen::CwiseNullaryOp<Eigen::internal::linspaced_op<int, true>, Eigen::VectorXi >, Eigen::MatrixXi >(Eigen::MatrixBase<Eigen::CwiseNullaryOp<Eigen::internal::linspaced_op<int, true>, Eigen::VectorXi > > const&, int, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
template void igl::nchoosek<Eigen::VectorXi, Eigen::MatrixXi >(Eigen::MatrixBase<Eigen::VectorXi > const&, int, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
#endif

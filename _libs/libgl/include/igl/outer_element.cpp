...
template void igl::outer_facet<Eigen::MatrixX3d, Eigen::MatrixX3i, Eigen::MatrixX3d, Eigen::VectorXl, int>(Eigen::PlainObjectBase<Eigen::MatrixX3d > const&, Eigen::PlainObjectBase<Eigen::MatrixX3i > const&, Eigen::PlainObjectBase<Eigen::MatrixX3d > const&, Eigen::PlainObjectBase<Eigen::VectorXl > const&, int&, bool&);
...
template void igl::outer_facet<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixX3d, Eigen::VectorXi, int>(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::MatrixX3d > const&, Eigen::PlainObjectBase<Eigen::VectorXi > const&, int&, bool&);
template void igl::outer_facet<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixXd, Eigen::VectorXi, int>(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::VectorXi > const&, int&, bool&);
#endif

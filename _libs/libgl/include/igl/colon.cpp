...
template Eigen::VectorXd igl::colon<double, double, double>(double, double);
// generated by autoexplicit.sh
template void igl::colon<int, long, int, int>(int, long, int, Eigen::VectorXi&);
template void igl::colon<int, int, long, int>(int, int, long, Eigen::VectorXi&);
template void igl::colon<int, long, int>(int, long, Eigen::VectorXi&);
template void igl::colon<int, int, int>(int, int, Eigen::VectorXi&);
template void igl::colon<int,long long int,int>(int,long long int,Eigen::Matrix<int,-1,1,0,-1,1> &);
template void igl::colon<int, int, int, int>(int, int, int, Eigen::VectorXi&);
template void igl::colon<int, long, long>(int, long, Eigen::VectorXl&);
template void igl::colon<int, double, double, double>(int, double, double, Eigen::VectorXd&);
template void igl::colon<double, double, double>(double, double, Eigen::VectorXd&);
#ifdef WIN32
template void igl::colon<int, long long, long>(int, long long, class Eigen::Matrix<long, -1, 1, 0, -1, 1> &);
template void igl::colon<int, int, long>(int, int, class Eigen::Matrix<long, -1, 1, 0, -1, 1> &);
#endif
#endif

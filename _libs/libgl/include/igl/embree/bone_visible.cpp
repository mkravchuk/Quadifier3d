...
template void igl::embree::bone_visible<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::Vector3d, Eigen::VectorXb >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::Vector3d > const&, Eigen::PlainObjectBase<Eigen::Vector3d > const&, Eigen::PlainObjectBase<Eigen::VectorXb >&);
template void igl::embree::bone_visible<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::VectorXd, Eigen::VectorXb >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::VectorXd > const&, Eigen::PlainObjectBase<Eigen::VectorXd > const&, Eigen::PlainObjectBase<Eigen::VectorXb >&);
#endif

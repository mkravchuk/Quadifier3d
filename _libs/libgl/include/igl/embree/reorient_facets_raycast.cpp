...
template void igl::embree::reorient_facets_raycast<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixXi, Eigen::VectorXi >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::MatrixXi >&, Eigen::PlainObjectBase<Eigen::VectorXi >&);
template void igl::embree::reorient_facets_raycast<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::VectorXb, Eigen::VectorXi >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, int, int, bool, bool, bool, Eigen::PlainObjectBase<Eigen::VectorXb >&, Eigen::PlainObjectBase<Eigen::VectorXi >&);
template void igl::embree::reorient_facets_raycast<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::VectorXi, Eigen::VectorXi >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, int, int, bool, bool, bool, Eigen::PlainObjectBase<Eigen::VectorXi >&, Eigen::PlainObjectBase<Eigen::VectorXi >&);
#endif

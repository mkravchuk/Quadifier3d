...
template Eigen::MatrixXd igl::embree::line_mesh_intersection<Eigen::MatrixXd, Eigen::MatrixXi >(Eigen::MatrixXd const&, Eigen::MatrixXd const&, Eigen::MatrixXd const&, Eigen::MatrixXi const&);
#endif

...
template bool igl::writeSTL<Eigen::MatrixX3d, Eigen::MatrixX3i >(std::basic_string<char, std::char_traits<char>, std::allocator<char> > const&, Eigen::PlainObjectBase<Eigen::MatrixX3d > const&, Eigen::PlainObjectBase<Eigen::MatrixX3i > const&, bool);
template bool igl::writeSTL<Eigen::MatrixXd, Eigen::MatrixXi >(std::basic_string<char, std::char_traits<char>, std::allocator<char> > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, bool);

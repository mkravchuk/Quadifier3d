...
template void igl::face_areas<Eigen::Matrix<double, -1, 6>, Eigen::MatrixX4d >(Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 6> > const&, Eigen::PlainObjectBase<Eigen::MatrixX4d >&);
#endif

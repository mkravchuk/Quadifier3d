...
// generated by autoexplicit.sh
template bool igl::writeOFF<Eigen::MatrixXd, Eigen::MatrixXi >(std::basic_string<char, std::char_traits<char>, std::allocator<char> >, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&);
...
template bool igl::writeOFF<Eigen::MatrixX3d, Eigen::MatrixX3i >(std::basic_string<char, std::char_traits<char>, std::allocator<char> >, Eigen::PlainObjectBase<Eigen::MatrixX3d > const&, Eigen::PlainObjectBase<Eigen::MatrixX3i > const&);
template bool igl::writeOFF<Eigen::MatrixXd, Eigen::MatrixX3i >(std::basic_string<char, std::char_traits<char>, std::allocator<char> >, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixX3i > const&);

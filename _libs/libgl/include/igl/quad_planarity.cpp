...
template void igl::quad_planarity<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::VectorXd >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::VectorXd >&);
#endif

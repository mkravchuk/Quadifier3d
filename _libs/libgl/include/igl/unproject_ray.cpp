...
template void igl::unproject_ray<Eigen::Matrix<float, 2, 1, 0, 2, 1>, Eigen::Matrix4f, Eigen::Matrix4f, Eigen::Matrix<float, 4, 1, 0, 4, 1>, Eigen::Vector3f, Eigen::Vector3f >(Eigen::PlainObjectBase<Eigen::Matrix<float, 2, 1, 0, 2, 1> > const&, Eigen::PlainObjectBase<Eigen::Matrix4f > const&, Eigen::PlainObjectBase<Eigen::Matrix4f > const&, Eigen::PlainObjectBase<Eigen::Matrix<float, 4, 1, 0, 4, 1> > const&, Eigen::PlainObjectBase<Eigen::Vector3f >&, Eigen::PlainObjectBase<Eigen::Vector3f >&);
#endif

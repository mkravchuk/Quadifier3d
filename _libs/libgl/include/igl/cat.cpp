...
template Eigen::MatrixXd igl::cat<Eigen::MatrixXd >(int, Eigen::MatrixXd const&, Eigen::MatrixXd const&);
// generated by autoexplicit.sh
...
// generated by autoexplicit.sh
template Eigen::MatrixXi igl::cat<Eigen::MatrixXi >(int, Eigen::MatrixXi const&, Eigen::MatrixXi const&);
template void igl::cat<Eigen::VectorXd, Eigen::VectorXd >(int, Eigen::MatrixBase<Eigen::VectorXd > const&, Eigen::MatrixBase<Eigen::VectorXd > const&, Eigen::VectorXd&);
template Eigen::VectorXi igl::cat<Eigen::VectorXi >(int, Eigen::VectorXi const&, Eigen::VectorXi const&);
template Eigen::VectorXd igl::cat<Eigen::VectorXd >(int, Eigen::VectorXd const&, Eigen::VectorXd const&);
template void igl::cat<Eigen::MatrixXd, Eigen::MatrixXd >(int, Eigen::MatrixBase<Eigen::MatrixXd > const&, Eigen::MatrixBase<Eigen::MatrixXd > const&, Eigen::MatrixXd&);
template void igl::cat<Eigen::MatrixXi, Eigen::MatrixXi >(int, Eigen::MatrixBase<Eigen::MatrixXi > const&, Eigen::MatrixBase<Eigen::MatrixXi > const&, Eigen::MatrixXi&);
#endif

...
template void igl::polyRoots<std::complex<float>, float>(Eigen::Matrix<std::complex<float>, -1, 1, 0, -1, 1>&, Eigen::Matrix<std::complex<float>, -1, 1, 0, -1, 1>&);
...
template void igl::polyRoots<double, double>(Eigen::VectorXd&, Eigen::Matrix<std::complex<double>, -1, 1, 0, -1, 1>&);
#endif

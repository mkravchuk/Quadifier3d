...
template void igl::massmatrix<Eigen::MatrixX3d, Eigen::MatrixX4i, double>(Eigen::MatrixBase<Eigen::MatrixX3d > const&, Eigen::MatrixBase<Eigen::MatrixX4i > const&, igl::MassMatrixType, Eigen::SparseMatrix<double, 0, int>&);
// generated by autoexplicit.sh
template void igl::massmatrix<Eigen::MatrixX3d, Eigen::MatrixX3i, double>(Eigen::MatrixBase<Eigen::MatrixX3d > const&, Eigen::MatrixBase<Eigen::MatrixX3i > const&, igl::MassMatrixType, Eigen::SparseMatrix<double, 0, int>&);
...
template void igl::massmatrix<Eigen::MatrixXd, Eigen::MatrixXi, double>(Eigen::MatrixBase<Eigen::MatrixXd > const&, Eigen::MatrixBase<Eigen::MatrixXi > const&, igl::MassMatrixType, Eigen::SparseMatrix<double, 0, int>&);
#endif

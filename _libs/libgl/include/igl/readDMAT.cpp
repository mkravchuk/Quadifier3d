...
template bool igl::readDMAT<Eigen::MatrixXd >(std::string, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
...
template bool igl::readDMAT<Eigen::MatrixXi >(std::string, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
template bool igl::readDMAT<Eigen::Matrix<double, 4, 1, 0, 4, 1> >(std::string, Eigen::PlainObjectBase<Eigen::Matrix<double, 4, 1, 0, 4, 1> >&);
template bool igl::readDMAT<Eigen::VectorXd >(std::string, Eigen::PlainObjectBase<Eigen::VectorXd >&);
template bool igl::readDMAT<Eigen::VectorXi >(std::string, Eigen::PlainObjectBase<Eigen::VectorXi >&);
template bool igl::readDMAT<Eigen::MatrixX2i >(std::string, Eigen::PlainObjectBase<Eigen::MatrixX2i >&);

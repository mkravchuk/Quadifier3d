...
template bool igl::readOFF<Eigen::MatrixX3d, Eigen::MatrixXi >(std::basic_string<char, std::char_traits<char>, std::allocator<char> >, Eigen::PlainObjectBase<Eigen::MatrixX3d >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
// generated by autoexplicit.sh
template bool igl::readOFF<Eigen::MatrixXd, Eigen::MatrixXi >(std::basic_string<char, std::char_traits<char>, std::allocator<char> >, Eigen::PlainObjectBase<Eigen::MatrixXd >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
...
template bool igl::readOFF<Eigen::MatrixX3d, Eigen::MatrixX3i >(std::string, Eigen::PlainObjectBase<Eigen::MatrixX3d >&, Eigen::PlainObjectBase<Eigen::MatrixX3i >&);
template bool igl::readOFF<Eigen::MatrixXd, Eigen::MatrixXi >(std::basic_string<char, std::char_traits<char>, std::allocator<char> >, Eigen::PlainObjectBase<Eigen::MatrixXd >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
#endif

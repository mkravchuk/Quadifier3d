...
template void igl::cross_field_missmatch<Eigen::MatrixX3d, Eigen::MatrixX3i >(Eigen::PlainObjectBase<Eigen::MatrixX3d > const&, Eigen::PlainObjectBase<Eigen::MatrixX3i > const&, Eigen::PlainObjectBase<Eigen::MatrixX3d > const&, Eigen::PlainObjectBase<Eigen::MatrixX3d > const&, bool, Eigen::PlainObjectBase<Eigen::MatrixX3i >&);
template void igl::cross_field_missmatch<Eigen::MatrixXd, Eigen::MatrixXi >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, bool, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
template void igl::cross_field_missmatch<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixX3i >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, bool, Eigen::PlainObjectBase<Eigen::MatrixX3i >&);

...
template bool igl::ray_mesh_intersect<Eigen::Vector3f, Eigen::Vector3f, Eigen::MatrixXd, Eigen::MatrixXi >(Eigen::MatrixBase<Eigen::Vector3f > const&, Eigen::MatrixBase<Eigen::Vector3f > const&, Eigen::MatrixBase<Eigen::MatrixXd > const&, Eigen::MatrixBase<Eigen::MatrixXi > const&, std::vector<igl::Hit, std::allocator<igl::Hit> >&);
#endif

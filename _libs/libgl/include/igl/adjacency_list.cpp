...
template void igl::adjacency_list<Eigen::MatrixXi, int>(Eigen::PlainObjectBase<Eigen::MatrixXi > const&, std::vector<std::vector<int, std::allocator<int> >, std::allocator<std::vector<int, std::allocator<int> > > >&, bool);
template void igl::adjacency_list<Eigen::MatrixX3i, int>(Eigen::PlainObjectBase<Eigen::MatrixX3i > const&, std::vector<std::vector<int, std::allocator<int> >, std::allocator<std::vector<int, std::allocator<int> > > >&, bool);
#endif

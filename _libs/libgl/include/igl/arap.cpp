...
template bool igl::arap_solve<Eigen::MatrixXd, Eigen::MatrixXd >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, igl::ARAPData&, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
template bool igl::arap_precomputation<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::VectorXi >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, int, Eigen::PlainObjectBase<Eigen::VectorXi > const&, igl::ARAPData&);
#endif

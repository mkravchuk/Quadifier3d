...
template IGL_INLINE void igl::arap_linear_block<Eigen::MatrixXd, Eigen::MatrixXi, double>(Eigen::MatrixXd const&, Eigen::MatrixXi const&, int, igl::ARAPEnergyType, Eigen::SparseMatrix<double, 0, int>&);
#endif

...
template void igl::speye<float>(int, Eigen::SparseMatrix<float, 0, int>&);
template void igl::speye<double>(int, Eigen::SparseMatrix<double, 0, int>&);
template void igl::speye<std::complex<float> >(int, int, Eigen::SparseMatrix<std::complex<float>, 0, int>&);

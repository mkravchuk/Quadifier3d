...
template void igl::project_to_line<Eigen::MatrixXd, Eigen::VectorXd, Eigen::VectorXd, Eigen::VectorXd, Eigen::VectorXd >(Eigen::MatrixBase<Eigen::MatrixXd > const&, Eigen::MatrixBase<Eigen::VectorXd > const&, Eigen::MatrixBase<Eigen::VectorXd > const&, Eigen::PlainObjectBase<Eigen::VectorXd >&, Eigen::PlainObjectBase<Eigen::VectorXd >&);
#endif

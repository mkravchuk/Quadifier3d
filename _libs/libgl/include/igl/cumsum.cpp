...
template void igl::cumsum<Eigen::MatrixXd, Eigen::MatrixXd >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, int, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
template void igl::cumsum<Eigen::VectorXd, Eigen::VectorXd >(Eigen::PlainObjectBase<Eigen::VectorXd > const&, int, Eigen::PlainObjectBase<Eigen::VectorXd >&);
template void igl::cumsum<Eigen::Vector3d, Eigen::Vector3d >(Eigen::PlainObjectBase<Eigen::Vector3d > const&, int, Eigen::PlainObjectBase<Eigen::Vector3d >&);

...
template void igl::ismember<Eigen::MatrixXi, Eigen::MatrixXi, Eigen::Matrix<bool, -1, -1, 0, -1, -1>, Eigen::MatrixXi >(Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::Matrix<bool, -1, -1, 0, -1, -1> >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
#endif

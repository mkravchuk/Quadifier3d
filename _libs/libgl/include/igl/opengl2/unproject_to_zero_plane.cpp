...
template void igl::opengl2::unproject_to_zero_plane<Eigen::Vector3d, Eigen::Vector3d >(Eigen::PlainObjectBase<Eigen::Vector3d > const&, Eigen::PlainObjectBase<Eigen::Vector3d >&);
...
template void igl::opengl2::unproject_to_zero_plane<Eigen::Matrix<double, 2, 1, 0, 2, 1>, Eigen::Vector3d >(Eigen::PlainObjectBase<Eigen::Matrix<double, 2, 1, 0, 2, 1> > const&, Eigen::PlainObjectBase<Eigen::Vector3d >&);
#endif

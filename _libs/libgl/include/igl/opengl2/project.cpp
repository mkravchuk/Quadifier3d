...
template int igl::opengl2::project<Eigen::Vector3d, Eigen::Vector3d >(Eigen::PlainObjectBase<Eigen::Vector3d > const&, Eigen::PlainObjectBase<Eigen::Vector3d >&);
template Eigen::PlainObjectBase<Eigen::Vector3d > igl::opengl2::project<Eigen::Vector3d >(Eigen::PlainObjectBase<Eigen::Vector3d > const&);
template int igl::opengl2::project<Eigen::Vector3f, Eigen::Vector3f >(Eigen::PlainObjectBase<Eigen::Vector3f > const&, Eigen::PlainObjectBase<Eigen::Vector3f >&);
template Eigen::PlainObjectBase<Eigen::Vector3f > igl::opengl2::project<Eigen::Vector3f >(Eigen::PlainObjectBase<Eigen::Vector3f > const&);

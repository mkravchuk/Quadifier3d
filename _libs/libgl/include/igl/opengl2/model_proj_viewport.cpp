...
template void igl::opengl2::model_proj_viewport<Eigen::Matrix4f, Eigen::Matrix4f, Eigen::Matrix<float, 4, 1, 0, 4, 1> >(Eigen::PlainObjectBase<Eigen::Matrix4f >&, Eigen::PlainObjectBase<Eigen::Matrix4f >&, Eigen::PlainObjectBase<Eigen::Matrix<float, 4, 1, 0, 4, 1> >&);
#endif

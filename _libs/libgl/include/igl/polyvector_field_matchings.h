...
namespace igl {
  ...
  IGL_INLINE void polyvector_field_matching(
                                            ...
                                            bool is_symmetric, bool isFieldVectorsSorted = false);
  ...
  IGL_INLINE typename DerivedC::Scalar polyvector_field_matchings(
                                                                  ...
                                                                  Eigen::PlainObjectBase<DerivedC>& curl, bool isFieldVectorsSorted = false);
  ...
  IGL_INLINE void polyvector_field_matchings(
                                             ...
                                             bool is_symmetric,
                                             Eigen::PlainObjectBase<DerivedM>& match_ab,
                                             Eigen::PlainObjectBase<DerivedM>& match_ba, bool isFieldVectorsSorted = false);
  ...
  IGL_INLINE void polyvector_field_matchings(
                                             ...
                                             bool is_symmetric,
                                             Eigen::PlainObjectBase<DerivedM>& match_ab,
                                             Eigen::PlainObjectBase<DerivedM>& match_ba, bool isFieldVectorsSorted = false, bool IsOmpEnabled = true);

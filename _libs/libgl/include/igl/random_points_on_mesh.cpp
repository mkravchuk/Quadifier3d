...
template void igl::random_points_on_mesh<Eigen::MatrixXd, Eigen::MatrixXi, double, Eigen::MatrixXi >(int, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::SparseMatrix<double, 0, int>&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
template void igl::random_points_on_mesh<Eigen::MatrixXd, Eigen::MatrixXi, double, Eigen::VectorXi >(int, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::SparseMatrix<double, 0, int>&, Eigen::PlainObjectBase<Eigen::VectorXi >&);
#endif

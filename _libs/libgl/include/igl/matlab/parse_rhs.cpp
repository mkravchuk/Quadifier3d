...
template void igl::matlab::parse_rhs_index<Eigen::VectorXi >(mxArray_tag const**, Eigen::PlainObjectBase<Eigen::VectorXi >&);
template void igl::matlab::parse_rhs_index<Eigen::MatrixXi >(mxArray_tag const**, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
template void igl::matlab::parse_rhs_double<Eigen::MatrixXd >(mxArray_tag const**, Eigen::PlainObjectBase<Eigen::MatrixXd >&);

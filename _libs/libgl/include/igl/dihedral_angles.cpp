...
template void igl::dihedral_angles_intrinsic<Eigen::Matrix<double, -1, 6, 0, -1, 6>, Eigen::MatrixX4d, Eigen::Matrix<double, -1, 6, 0, -1, 6>, Eigen::Matrix<double, -1, 6, 0, -1, 6> >(Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 6, 0, -1, 6> >&, Eigen::PlainObjectBase<Eigen::MatrixX4d >&, Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 6, 0, -1, 6> >&, Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 6, 0, -1, 6> >&);
template void igl::dihedral_angles_intrinsic<Eigen::Matrix<double, -1, 6, EROW, -1, 6>, Eigen::MatrixX4d, Eigen::Matrix<double, -1, 6, EROW, -1, 6>, Eigen::Matrix<double, -1, 6, EROW, -1, 6> >(Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 6, EROW, -1, 6> >&, Eigen::PlainObjectBase<Eigen::MatrixX4d >&, Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 6, EROW, -1, 6> >&, Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 6, EROW, -1, 6> >&);
#endif

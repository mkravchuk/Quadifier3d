...
template void igl::normal_derivative<Eigen::MatrixXd, Eigen::MatrixXi, double>(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::SparseMatrix<double, 0, int>&);
#endif

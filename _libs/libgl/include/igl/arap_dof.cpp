...
template bool igl::arap_dof_update<Eigen::MatrixXd, double>(ArapDOFData<Eigen::MatrixXd, double> const&, Eigen::VectorXd const&, Eigen::MatrixXd const&, int, double, Eigen::MatrixXd&);
template bool igl::arap_dof_recomputation<Eigen::MatrixXd, double>(Eigen::VectorXi const&, Eigen::SparseMatrix<double, 0, int> const&, ArapDOFData<Eigen::MatrixXd, double>&);
template bool igl::arap_dof_precomputation<Eigen::MatrixXd, double>(Eigen::MatrixXd const&, Eigen::MatrixXi const&, Eigen::MatrixXd const&, Eigen::VectorXi const&, ArapDOFData<Eigen::MatrixXd, double>&);
template bool igl::arap_dof_update<Eigen::MatrixXd, float>(igl::ArapDOFData<Eigen::MatrixXd, float> const&, Eigen::VectorXd const&, Eigen::MatrixXd const&, int, double, Eigen::MatrixXd&);
template bool igl::arap_dof_recomputation<Eigen::MatrixXd, float>(Eigen::VectorXi const&, Eigen::SparseMatrix<double, 0, int> const&, igl::ArapDOFData<Eigen::MatrixXd, float>&);
template bool igl::arap_dof_precomputation<Eigen::MatrixXd, float>(Eigen::MatrixXd const&, Eigen::MatrixXi const&, Eigen::MatrixXd const&, Eigen::VectorXi const&, igl::ArapDOFData<Eigen::MatrixXd, float>&);
#endif

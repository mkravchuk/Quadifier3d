...
template void igl::hsv_to_rgb<Eigen::MatrixXd, Eigen::MatrixXd >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
template void igl::hsv_to_rgb<Eigen::MatrixXf, Eigen::MatrixXf >(Eigen::PlainObjectBase<Eigen::MatrixXf > const&, Eigen::PlainObjectBase<Eigen::MatrixXf >&);

...
template void igl::planarize_quad_mesh<Eigen::MatrixXd, Eigen::MatrixXi >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, int, double const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
#endif

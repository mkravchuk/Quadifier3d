...
namespace igl
{
    ...
    IGL_INLINE bool segments_intersect(
            const Eigen::PlainObjectBase <DerivedSource> &point1,
            const Eigen::PlainObjectBase <DerivedDir> &direction1,
            const Eigen::PlainObjectBase <DerivedSource> &point2,
            const Eigen::PlainObjectBase <DerivedDir> &direction2,
            double &t,
            double &u,
            double eps = 1e-6
    );

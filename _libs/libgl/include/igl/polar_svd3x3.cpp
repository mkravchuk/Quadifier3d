...
template void igl::polar_svd3x3<Eigen::Matrix3d >(Eigen::Matrix3d const&, Eigen::Matrix3d&);
template void igl::polar_svd3x3<Eigen::Matrix3f >(Eigen::Matrix3f const &,Eigen::Matrix3f &);

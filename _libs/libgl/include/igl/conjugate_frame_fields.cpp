...
template Eigen::MatrixXd::Scalar igl::conjugate_frame_fields<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixXd >(igl::ConjugateFFSolverData<Eigen::MatrixXd, Eigen::MatrixXi > const&, Eigen::VectorXi const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&, int, Eigen::MatrixXd::Scalar, Eigen::MatrixXd::Scalar, Eigen::MatrixXd::Scalar, bool);
#endif

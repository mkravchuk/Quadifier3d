...
template void igl::diag<double, Eigen::MatrixXd >(Eigen::SparseMatrix<double, 0, int> const&, Eigen::MatrixBase<Eigen::MatrixXd >&);
template void igl::diag<double>(Eigen::SparseMatrix<double, 0, int> const&, Eigen::SparseVector<double, 0, int>&);
template void igl::diag<double, Eigen::VectorXd >(Eigen::MatrixBase<Eigen::VectorXd > const&, Eigen::SparseMatrix<double, 0, int>&);

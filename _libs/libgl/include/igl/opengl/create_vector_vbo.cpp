...
template void igl::opengl::create_vector_vbo<int>(Eigen::MatrixXi const&, unsigned int&);
// generated by autoexplicit.sh
template void igl::opengl::create_vector_vbo<double>(Eigen::MatrixXd const&, unsigned int&);
#endif

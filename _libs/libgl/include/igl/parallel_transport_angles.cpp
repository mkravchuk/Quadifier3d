...
template void igl::parallel_transport_angles<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::VectorXd >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::MatrixXi const&, Eigen::MatrixXi const&, Eigen::PlainObjectBase<Eigen::VectorXd >&);
#endif

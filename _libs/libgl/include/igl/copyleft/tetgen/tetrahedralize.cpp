...
template int igl::copyleft::tetgen::tetrahedralize<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixXi >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, std::basic_string<char, std::char_traits<char>, std::allocator<char> >, Eigen::PlainObjectBase<Eigen::MatrixXd >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
template int igl::copyleft::tetgen::tetrahedralize<Eigen::MatrixXd,Eigen::MatrixXi,Eigen::VectorXi,Eigen::VectorXi,Eigen::MatrixXd,Eigen::MatrixXi,Eigen::MatrixXi,Eigen::VectorXi >(const Eigen::PlainObjectBase<Eigen::MatrixXd > &,const Eigen::PlainObjectBase<Eigen::MatrixXi > &,const Eigen::PlainObjectBase<Eigen::VectorXi > &,const Eigen::PlainObjectBase<Eigen::VectorXi > &,const std::basic_string<char, std::char_traits<char>, std::allocator<char> >,Eigen::PlainObjectBase<Eigen::MatrixXd > &,Eigen::PlainObjectBase<Eigen::MatrixXi > &,Eigen::PlainObjectBase<Eigen::MatrixXi > &, Eigen::PlainObjectBase<Eigen::VectorXi > &);
#endif

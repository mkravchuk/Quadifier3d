...
template bool igl::copyleft::tetgen::tetgenio_to_tetmesh<Eigen::MatrixXd, Eigen::MatrixXi >(tetgenio const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
#endif

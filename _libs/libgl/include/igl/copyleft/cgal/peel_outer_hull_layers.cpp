...
template size_t igl::copyleft::cgal::peel_outer_hull_layers<Eigen::MatrixX3d, Eigen::MatrixX3i, Eigen::VectorXi, Eigen::VectorXi >(Eigen::PlainObjectBase<Eigen::MatrixX3d > const&, Eigen::PlainObjectBase<Eigen::MatrixX3i > const&, Eigen::PlainObjectBase<Eigen::VectorXi >&, Eigen::PlainObjectBase<Eigen::VectorXi >&);
#endif

...
template void igl::upsample<Eigen::MatrixXd, Eigen::MatrixXi, Eigen::MatrixXd, Eigen::MatrixXi >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&, Eigen::PlainObjectBase<Eigen::MatrixXi >&, int);
template void igl::upsample<Eigen::MatrixXi, double, Eigen::MatrixXi >(int, Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::SparseMatrix<double, 0, int>&, Eigen::PlainObjectBase<Eigen::MatrixXi >&);
template void igl::upsample<Eigen::MatrixXd, Eigen::MatrixXi >(Eigen::MatrixXd&, Eigen::MatrixXi&, int);
#endif

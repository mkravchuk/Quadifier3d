...
#ifndef WIN32
template unsigned long igl::extract_manifold_patches<Eigen::MatrixXi, Eigen::VectorXi, unsigned long, Eigen::VectorXi >(Eigen::PlainObjectBase<Eigen::MatrixXi > const&, Eigen::PlainObjectBase<Eigen::VectorXi > const&, std::vector<std::vector<unsigned long, std::allocator<unsigned long> >, std::allocator<std::vector<unsigned long, std::allocator<unsigned long> > > > const&, Eigen::PlainObjectBase<Eigen::VectorXi >&);
#endif
#endif

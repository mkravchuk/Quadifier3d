...
template void igl::dqs<Eigen::MatrixXd, Eigen::MatrixXd, Eigen::Quaternion<double, 0>, Eigen::aligned_allocator<Eigen::Quaternion<double, 0> >, Eigen::Vector3d, Eigen::MatrixXd >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::PlainObjectBase<Eigen::MatrixXd > const&, std::vector<Eigen::Quaternion<double, 0>, Eigen::aligned_allocator<Eigen::Quaternion<double, 0> > > const&, std::vector<Eigen::Vector3d, std::allocator<Eigen::Vector3d > > const&, Eigen::PlainObjectBase<Eigen::MatrixXd >&);
#endif

...
template bool igl::eigs<double, double, Eigen::MatrixXd, Eigen::VectorXd >(Eigen::SparseMatrix<double, 0, int> const&, Eigen::SparseMatrix<double, 0, int> const&, unsigned long, igl::EigsType, Eigen::PlainObjectBase<Eigen::MatrixXd >&, Eigen::PlainObjectBase<Eigen::VectorXd >&);
#ifdef WIN32

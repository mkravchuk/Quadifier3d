...
template void igl::sparse<Eigen::VectorXi, Eigen::VectorXd, double>(Eigen::VectorXi const&, Eigen::VectorXi const&, Eigen::VectorXd const&, size_t, size_t, Eigen::SparseMatrix<double, 0, int>&);
template void igl::sparse<Eigen::MatrixXd, double>(Eigen::PlainObjectBase<Eigen::MatrixXd > const&, Eigen::SparseMatrix<double, 0, int>&);
template Eigen::SparseMatrix<Eigen::MatrixXd::Scalar, 0, int> igl::sparse<Eigen::MatrixXd >(Eigen::PlainObjectBase<Eigen::MatrixXd > const&);
template Eigen::SparseMatrix<Eigen::VectorXd::Scalar, 0, int> igl::sparse<Eigen::VectorXd >(Eigen::PlainObjectBase<Eigen::VectorXd > const&);
template void igl::sparse<Eigen::VectorXi, Eigen::CwiseNullaryOp<Eigen::internal::scalar_constant_op<double>, Eigen::VectorXd >, double>(Eigen::VectorXi const&, Eigen::VectorXi const&, Eigen::CwiseNullaryOp<Eigen::internal::scalar_constant_op<double>, Eigen::VectorXd > const&, Eigen::SparseMatrix<double, 0, int>&);
template void igl::sparse<Eigen::VectorXi, Eigen::VectorXd, double>(Eigen::VectorXi const&, Eigen::VectorXi const&, Eigen::VectorXd const&, Eigen::SparseMatrix<double, 0, int>&);

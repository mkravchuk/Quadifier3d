...
{
private:
    LDLTFloatSolver solver_LDLTFloat;
    ...
    #endif
public:
    AnySolver(MeshLogicOptions_LinearEquationSolver::LinearEquationSolverType type);
...
AnySolver::AnySolver(MeshLogicOptions_LinearEquationSolver::LinearEquationSolverType type)
    :Type(type)
{
}

ComputationInfo AnySolver::compute(const SparceMatrixType &Quu)
{
...
ComputationInfo AnySolver::solve(const Matrix<Scalar, Dynamic, Dynamic, ColMajor>& rhsM, Matrix<Scalar, Dynamic, Dynamic, ColMajor>& bM)
{
...
{
    solver = new AnySolver(options.Solver);
}
...
bool LinearEquationSolver::IsAlreadyComputed()
{
    return compute_info != ComputationInfo::InvalidInput;
}

bool LinearEquationSolver::compute(const SparceMatrixType &Quu, bool logMessages)
{
...
bool LinearEquationSolver::solve(const Is& isFaceConstrained, const SparceMatrixType &Quk,
